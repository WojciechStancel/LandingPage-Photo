...
const paths = {
	...
	img: "./src/img/*",
	icons: "./src/img/icons/*",
	companies: "./src/img/companies/*",
	dist: "./dist",
	sassDest: "./dist/css",
	jsDest: "./dist/js",
	imgDest: "./dist/img",
	iconDest: "./dist/img/icons",
	companiesDest: "./dist/img/companies",
};
...
function convertImages(done) {
	...
	src(paths.icons).pipe(imagemin()).pipe(dest(paths.iconDest));
	src(paths.companies).pipe(imagemin()).pipe(dest(paths.companiesDest));
